/**
 * Test file for Job: uptimerobot
 */

var assert = require ('assert');
uptimerobotSUT = require('../uptimerobot');

var mockedConfig, mockedDependencies;

describe ('uptimerobot test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      uptimerobotSUT(config, mockedDependencies, function(err, data){
